                ...
                <div class="col-md-3 col-sm-2">
                    <section id="sidebar">
                        ...
                        <aside>
                           ...
                           <#if loginUser.type=2> <li  ><a href="/house/ownlist"><i class="fa fa-home"></i><span>我的房产信息</span></a></li></#if>
                                <li  class="active" ><a href="/house/bookmarked"><i class="fa fa-heart"></i><span>房产收藏 </span></a></li>
                            </ul>
                        </aside>
                    </section>
                </div>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                 ...
                                 <tr>
                                     ...
                                     <td class="actions">
                                         <a href="/house/unbookmark?id=${house.id}"><i class="delete fa fa-trash-o"></i></a>
                                     </td>
                                 </tr>
                                 </#list>
                                    </tbody>
