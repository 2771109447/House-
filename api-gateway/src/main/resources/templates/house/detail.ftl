                    ...
                    <section id="property-detail">
                        ...
                        <#if loginUser??>
                            <span class="actions">
                                ...
                                ><span class="title-add">添加收藏</span><span class="title-added">取消收藏</span></a>
                            </span>
                       </#if>
                        </header>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <section id="comments">
                                    <div class="agent-form">
                                                    <form role="form" id="form-contact-agent" method="post" action="/comment/addHouseComment" class="clearfix">
                                                        <input type="hidden" name="houseId" value="${house.id}">
                                                        <div class="form-group">
 ...
 <script  type="text/javascript" >
    ...
    bookmarkButton.on("click", function() {
        if (bookmarkButton.data('bookmark-state') == 'empty') {
            ...
            commonAjax('/house/unbookmark1?id=${house.id}');
        }
    });
